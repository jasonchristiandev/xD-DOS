...
typedef enum : uint8_t {
	...
	ACPI_INIT_VERSION_NOT_SUPPORTED = 2,
	ACPI_INIT_XSDT_NOT_FOUND = 3,
	ACPI_INIT_MADT_NOT_FOUND = 4,
	ACPI_INIT_IO_APIC_ENTRY_NOT_FOUND = 5,
	ACPI_INIT_RSDP_SIGNATURE_FAIL = 255 - 0,
	ACPI_INIT_XSDT_SIGNATURE_FAIL = 255 - 1
} acpi_init_result_t;
